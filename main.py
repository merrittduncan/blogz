...
class Test(BlogHandler):
    ...
    def get(self):
        ...
        userkey = user.key().id()
        s = self.get_user_by_name(username=userkey)
...
class LoginHandler(BlogHandler):
    ...
    def get(self):
        self.render_login_form(username_error="",password_error="")
    ...
    def post(self):
        ...
        if not user:
            self.render_login_form(username_error="Invalid username", password_error="")
        elif hashutils.valid_pw(submitted_username, submitted_password, user.pw_hash):
            self.login_user(user)
            self.redirect('/blog/newpost')
        else:
            self.render_login_form(username_error="",password_error="Invalid password")
